...
struct qt_meta_stringdata_GlobalHotkey_t {
    QByteArrayData data[3];
    char stringdata0[24];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_GlobalHotkey_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_GlobalHotkey_t qt_meta_stringdata_GlobalHotkey = {
    {
QT_MOC_LITERAL(0, 0, 12), // "GlobalHotkey"
QT_MOC_LITERAL(1, 13, 9), // "activated"
QT_MOC_LITERAL(2, 23, 0) // ""

    },
    "GlobalHotkey\0activated\0"
};
...
void GlobalHotkey::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<GlobalHotkey *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (GlobalHotkey::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GlobalHotkey::activated)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject GlobalHotkey::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_GlobalHotkey.data,
    qt_meta_data_GlobalHotkey,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *GlobalHotkey::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_GlobalHotkey.stringdata0))
